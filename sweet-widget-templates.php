<?php
/*
Plugin Name:       Sweet Widget Templates
Plugin URI:        https://github.com/daggerhart/sweet-widget-templates
GitHub Plugin URI: https://github.com/daggerhart/sweet-widget-templates
GitHub Branch:     master
Description:       Provide the theme with widget templates.
...
if ( ! class_exists('Sweet_Widgets_Templates') ) :
	...
	add_action( 'init', array( 'Sweet_Widgets_Templates', 'register') );
endif; // class exists
